        ...
        if type(multi) != type([]):
            ...
            for i in range(len(self.mat)):
                ...
                for j in range(len(multi[0])):
                    m[i].append(self.mat[i][0]*multi[0][j] + self.mat[i]
                                [1]*multi[1][j] + self.mat[i][2]*multi[2][j])
        return m
    ...
    def get_multiplied(self, multi):
        ...
        if type(multi) != type([]):
            ...
            for i in range(len(multi)):
                m.append([])
                for j in range(len(self.mat)):
                    m[i].append(multi[i][0]*self.mat[0][j] + multi[i]
                                [1]*self.mat[1][j] + multi[i][2]*self.mat[2][j])
        return m
