...
periodic_table = {
    ...
    # halogen
    "X": {'query': True, 'ord': 300, 'key': '"X"', 'weight': 0, 'valency': (1,)},
    # anything not H or C
    "Q": {'query': True, 'ord': 301, 'key': '"Q"', 'weight': 0, 'valency': (1, 2, 3, 4)},
    # anything not H
    "A": {'query': True, 'ord': 302, 'key': '"A"', 'weight': 0, 'valency': (1, 2, 3, 4)},
    # anything
    "R": {'query': True, 'ord': 303, 'key': '"R"', 'weight': 0, 'valency': (1, 2, 3, 4)},
}
